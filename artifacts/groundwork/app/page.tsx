    ...
    <div style={{ backgroundColor: "#f8f6f2", minHeight: "100vh" }}>
      ...
      <nav className="px-8 py-5 flex items-center justify-between max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-6">
          <Link href="/gallery" className="text-sm text-[#5c5c54] hover:text-[#1a1a18] transition-colors">
            Gallery
          </Link>
          <Link href="/contact" className="text-sm text-[#5c5c54] hover:text-[#1a1a18] transition-colors">
            Get a Quote
          </Link>
          <Link
            href="/admin/dashboard"
            className="text-xs font-medium px-3 py-1.5 rounded-lg border border-[#e0dbd0] text-[#5c5c54] hover:bg-white transition-colors"
          >
            Admin
          </Link>
        </div>
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-8 py-28">
          <p className="text-xs font-semibold tracking-widest uppercase mb-4" style={{ color: "#c8a55a" }}>
          ...
          <p className="mt-6 text-lg max-w-xl leading-relaxed" style={{ color: "#c8d8cc" }}>
          ...
          <div className="mt-10 flex items-center gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm text-[#1c3829] transition-colors hover:opacity-90"
            ...
            <Link
              href="/gallery"
              className="text-sm font-medium text-white hover:text-[#c8a55a] transition-colors"
            >
              View our work →
            </Link>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-8 py-20">
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <h2 className="text-3xl font-bold text-[#1a1a18]">Recent builds</h2>
          </div>
          <Link href="/gallery" className="text-sm font-medium text-[#1c3829] hover:underline flex items-center gap-1">
        ...
        <div className="grid grid-cols-3 gap-4">
          {GALLERY_PREVIEW.slice(0, 6).map((img, i) => (
            <div
              key={i}
              className="aspect-[4/3] rounded-xl overflow-hidden bg-[#e8e4dc]"
      ...
      {/* Features */}
      <section style={{ backgroundColor: "#1c3829" }}>
        <div className="max-w-6xl mx-auto px-8 py-20">
          <div className="grid grid-cols-3 gap-10">
            {FEATURES.map(({ icon: Icon, title, body }) => (
              <div key={title}>
                <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-4"
                  style={{ backgroundColor: "#c8a55a22" }}>
                  <Icon className="w-5 h-5" style={{ color: "#c8a55a" }} />
                </div>
                <h3 className="font-semibold text-white text-lg mb-2">{title}</h3>
                <p className="text-sm leading-relaxed" style={{ color: "#8aa89a" }}>{body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-8 py-20 text-center">
        ...
        <p className="text-[#5c5c54] mb-8 max-w-lg mx-auto">
      ...
      {/* Footer */}
      <footer className="border-t border-[#e8e4dc] px-8 py-8">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-5 text-xs text-[#a09890]">
            <Link href="/gallery" className="hover:text-[#1a1a18]">Gallery</Link>
            <Link href="/contact" className="hover:text-[#1a1a18]">Contact</Link>
            <Link href="/admin/dashboard" className="hover:text-[#1a1a18]">Admin</Link>
          </div>
        </div>
      </footer>
    </div>
