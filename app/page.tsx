    ...
    <div className="bg-surface text-[#191c1b]">
      ...
      <header className="fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl rounded-xl bg-stone-50/80 backdrop-blur-md shadow-[0_20px_50px_rgba(25,28,27,0.06)] z-50 flex justify-between items-center px-8 py-4 transition-all duration-300">
        ...
        <nav className="hidden md:flex items-center space-x-10">
          <a
            href="#process"
            className="text-emerald-800/70 hover:text-emerald-900 transition-colors label-style text-xs font-medium"
          >
            Process
          </a>
          <a
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            ...
            className="text-xs label-style text-emerald-800/40 hover:text-emerald-900 transition-colors"
          >
            Admin
          </Link>
        </div>
        ...
        <section className="relative min-h-[115vh] flex items-end pt-24 pb-28 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
            <div className="max-w-2xl">
              ...
              <h1 className="text-6xl md:text-8xl text-white font-light leading-[1.0] mb-8">
          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
              <div className="max-w-xl">
                ...
                <h2 className="text-5xl text-[#191c1b]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              {[
                ...
                <div key={step.n} className="relative">
                  <div className="text-6xl font-serif text-white/10 absolute -top-8 -left-4 select-none">
                    {step.n}
                  </div>
        ...
        <section className="py-32 bg-surface overflow-hidden relative">
          <div className="max-w-7xl mx-auto px-8 text-center">
            <div className="bg-surface-container-high rounded-2xl py-24 px-8 relative overflow-hidden">
              ...
              <h2 className="text-5xl md:text-6xl mb-8 max-w-2xl mx-auto">
                Ready to build something special?
              </h2>
              <p className="text-[#424844] text-xl mb-12 max-w-xl mx-auto">
                Join the waiting list for our next design window. Limited
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <p className="text-[#424844]/60 text-sm font-medium label-style">
                  Est. Project Start: Sept 2025
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-stone-100 mt-32">
        <div className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            <div className="font-serif text-xl text-primary mb-6">
              Groundwork
            </div>
            <p className="text-stone-600 max-w-sm text-sm leading-relaxed mb-8">
              Crafting architectural outdoor habitats for domestic animals. We
              believe high-end design should extend beyond the four walls of
              your home.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="#process"
                  className="text-stone-600 text-sm hover:text-primary underline decoration-amber-700/30 transition-all"
                >
                  Process
                </a>
              </li>
