  ...
  if (!lead) {
    return (
      <div className="p-8">
        ...
        <Link href="/admin/leads" className="text-sm text-espresso hover:underline mt-2 inline-block">
          Back to leads
        </Link>
      </div>
    );
  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-sm text-charcoal font-medium">{lead.name}</span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2 space-y-5">
          ...
          <div className="bg-white rounded-xl border border-border p-6">
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-xl font-bold text-charcoal">{lead.name}</h1>
              ...
              >
                {STATUS_OPTIONS.map((s) => (
                  <option key={s} value={s} className="text-charcoal capitalize">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center gap-2 text-sm text-stone">
                ...
                <a href={`mailto:${lead.email}`} className="hover:text-espresso">
                  {lead.email}
                </a>
              </div>
              {lead.phone && (
            ...
            <div className="space-y-3 mb-4">
              {lead.notes.map((note, i) => (
                <div key={i} className="relative pl-4 border-l-2 border-border">
                  <p className="text-sm text-charcoal leading-relaxed">{note.text}</p>
        ...
        <div className="space-y-5">
          ...
          {/* Actions */}
          <div className="bg-white rounded-xl border border-border p-5">
            <h3 className="font-semibold text-sm text-charcoal mb-3">Actions</h3>
